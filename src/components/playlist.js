...
export default function Playlist({ hidePlaylist }) {
  return (
    <ul className={`playlist ${hidePlaylist}`}>
      ...
      <li title="undefined" class="">
        <span data-id="name">
          27-7. Review of Explain VLAN Concepts and Configure VLANs on a Single
          Switch.mp4
        </span>
        <span data-id="duration">--:--</span>
      </li>
      ...
      <li title="undefined" class="">
        <span data-id="name">0005 Turning VS Code Into a Flutter IDE.mp4</span>
        <span data-id="duration">--:--</span>
      </li>
      <li title=" " class="file-separator">
        <span data-id="name"> </span>
      ...
      <li title="undefined">
        <span data-id="name">3.Advantages and Disadvantages to Yield.mp4</span>
        <span data-id="duration">--:--</span>
      </li>
      <li title="undefined">
